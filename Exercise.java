...
if (args.length==0){
    System.out.println("Default exersice is OneDimensionalArrays");
    return exercise=new OneDimensionalArrays();
}
switch (args[0]){
        ...
        case "TwoDimensionalArrays":{
            return exercise=new TwoDimensionalArrays();
        }
        case "Inheritance":{
            return exercise=new Inheritance();
        }
        default:{
            System.out.println("This exercise not exists. Default exersice is OneDimensionalArrays");
            return exercise=new OneDimensionalArrays();
        }
    }
    }
